...
public class SalaryCalculator {
    public static void main(String[] args) {
        ...
        int Fri = sc.nextInt();
        int Sat = sc.nextInt();
        int totalSalary, bonus, weeklyBonus, extraWeeklySalary=0;
        ...
        totalSalary = salaryMon + salaryTue + salaryWed + salaryThu + salaryFri + salarySat + salarySun + extraWeeklySalary;
